...
export default class FormularioCadastroServico extends Component<props, state> {
    ...
    handleInputChange = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        this.setState({ ...this.state, [name]: name === 'preco' ? parseFloat(value) : value } as unknown as Pick<state, keyof state>);
    }
    ...
    handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            await api.servico.createServico(servicoData);
            ...
            if (this.props.onServicoAdicionado) {
                this.props.onServicoAdicionado();
            }
        } catch (error) {
            console.error("Erro ao cadastrar serviço:", error);
            this.setState({
                loading: false,
                error: "Erro ao cadastrar serviço. Verifique os dados e tente novamente."
            });
        }
    }
